...
vi.mock('../src/components/ImgGenUtils/overlays/ImageOverlay', () => ({
  ImageOverlay: vi.fn(({ promptText, showControls, statusText }) => (
    <div data-testid="mock-image-overlay" data-prompt={promptText} data-show-controls={showControls} data-status={statusText} className="imggen-overlay">
...
describe('ImgGenPlaceholder Component', () => {
  ...
  describe('Error State', () => {
    ...
    it('handles and formats JSON error messages properly', () => {
      const jsonError = new Error('Error: {"error": "Custom Error Title", "details": {"error": {"message": "Custom error details"}}}');
