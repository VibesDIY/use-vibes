...
export const c = {
  ...
  favStarOn:
    'shrink-0 -ml-0.5 mt-[2px] text-[#E83D6F] hover:scale-110 active:scale-95 transition-all',
  ...
  linkInput:
    'flex-1 min-w-0 bg-[#FFF6E5] border-[3px] border-[#1A1A1A] px-3 py-2 text-[0.82rem] font-bold truncate',
