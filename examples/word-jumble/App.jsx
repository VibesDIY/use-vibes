...
export default function App() {
  ...
  const c = {
    ...
    btnGhost:
      'min-h-[44px] px-4 py-3 rounded-xl bg-white/10 hover:bg-white/15 font-semibold transition disabled:opacity-40',
    ...
    <div className={c.page}>
      ...
      <main id="app" className={c.main}>
        <section id="answer" className={c.section}>
          ...
          {state === 'won' && (
            <p className="text-center mt-3 text-[#7fe0b0] font-bold">Solved! 🎉</p>
          )}
          {state === 'revealed' && (
            <p className="text-center mt-3 text-white/60">
              It was “{round.word}” — next one's yours.
            </p>
          )}
        </section>
        <section id="tiles" className={c.section}>
                ...
                <button
                  ...
                  className={
                    ...
                    (used
                      ...
                      : ' bg-[#2f9e6e]/30 border border-[#2f9e6e]/60 hover:bg-[#2f9e6e]/50')
                  }
                >
                  {ch}
                </button>
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              onClick={undo}
              disabled={state !== 'play' || picked.length === 0}
            >
              ⌫ Undo
            </button>
        ...
        <section id="stats" className={c.section}>
          ...
          <div className="flex">
            <div className={c.statBox}>
              <div className={c.statNum}>{stats.solved}</div>
              <div className={c.statLabel}>Solved</div>
            </div>
            <div className={c.statBox}>
