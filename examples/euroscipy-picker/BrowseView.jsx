    ...
    <div>
      <div className="mb-1.5 flex flex-wrap gap-1">
        ...
        <select
          ...
          className={`p-2 m-0.5 ${c.border} rounded-2xl font-bold bg-white dark:bg-[#15202b] ${c.bodyText}`}
        >
      ...
      {/* Group into per-day sections with headers, matching the My Faves page. Events
          carry a conference-day `day` (4 AM cutoff), so an after-midnight session sorts
