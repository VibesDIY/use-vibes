...
export const c = {
  ...
  input:
    'p-[7px] m-0.5 rounded-xl font-bold text-[#22303c] dark:text-[#e4edf5] bg-white dark:bg-[#15202b]',
  navBtn: (active) =>
  ...
  btnAccent:
    'bg-[#FFD43B] text-[#1a1a1a] font-bold py-[7px] px-2.5 rounded-2xl m-0.5 hover:opacity-90 transition-all',
  btnBlue:
    'bg-[#4B8BBE] dark:bg-[#1d3a55] text-white font-bold py-[7px] px-2.5 rounded-2xl m-0.5 hover:opacity-90 transition-all',
  // Same button, in-flight: color-only cue (yellow) while the write lands. Copy is unchanged.
  btnBlueWorking:
    'bg-[#FFD43B] text-[#1a1a1a] font-bold py-[7px] px-2.5 rounded-2xl m-0.5 opacity-90 transition-all cursor-wait',
  badge: 'bg-[#FFD43B] text-[#1a1a1a] px-[3px] py-[1px] rounded-full text-sm font-bold m-0.5',
  favToggleOn:
    'p-[7px] rounded-2xl m-0.5 font-bold transition-all bg-[#FFD43B] text-[#1a1a1a] hover:opacity-90',
  favToggleOff:
...
export const lineupTag = (event) => {
  ...
  return {
    label,
    color: event.lineup?.color || '#306998',
