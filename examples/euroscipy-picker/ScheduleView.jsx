...
function GapStrip({ startMs, endMs, allDayEvents, fmtTime }) {
  ...
  return (
    <div className="rounded-lg m-0.5 px-[7px] py-[5px] bg-white/40 dark:bg-white/10 flex items-center gap-0.5">
      <span className="text-xs font-bold text-[#22303c]/60 dark:text-[#e4edf5]/60">
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-0.5 flex-wrap mb-[1px]">
                          ...
                          {isEvent && onToggleFavorite && (
                            <button
                              ...
                              className={`p-[1px] rounded-lg m-0.5 text-xs font-bold px-0.5 ${myFavIds && myFavIds.has(item.data.eventId) ? "bg-[#FFD43B] text-[#1a1a1a]" : "bg-white dark:bg-[#15202b] text-[#22303c] dark:text-[#e4edf5]"}`}
                            >
                        ...
                        {isEvent && item.data.speakers && (
                          <p className={`text-sm font-bold text-[#22303c]/70 dark:text-[#e4edf5]/70`}>{item.data.speakers}</p>
                        )}
                        ...
                        {isEvent &&
                          (canWrite && saveNote ? (
                            ...
                            <div className={`mt-0.5 p-1.5 bg-[#eef2f6] dark:bg-[#15202b] rounded-lg m-0.5`}>
