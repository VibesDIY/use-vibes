...
export default function App() {
  ...
  const c = {
    ...
    header:
      'sticky top-0 bg-[#1a1a1a] border-b border-white/15 px-4 py-3 flex items-center justify-between',
    ...
    <div className={c.page}>
      ...
      <main id="app" className={c.main}>
        ...
        <section id="stats" className={c.section}>
          ...
          {game.completed && (
            <p className="text-center mt-3 text-[#7dde4a] font-mono text-sm">✦ Complete! ✦</p>
          )}
        </section>
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    ' ' +
                    (t.matched
                      ? 'opacity-40 bg-[#7dde4a]/10 border-[#7dde4a]/50'
                      : show
                        ? 'bg-[#7dde4a]/10 border-[#7dde4a]/50'
                        : c.tileBack)
                  }
                >
                  {show ? (
                    ...
                    <span className="text-[#7040a0] text-lg select-none">✦</span>
                  )}
                </button>
              );
            })}
                ...
                >
                  ...
                  {b ? (
                    <span className="text-sm font-mono">
                      <span className="text-[#7dde4a]">{b.moves}</span> moves ·{' '}
