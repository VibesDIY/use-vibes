...
export default function App() {
  ...
  // Palette shared with system/word-jumble (the Games-lane parent) so the
      ...
      <main id="app" className={c.main}>
        ...
        {pangramCelebrate && (
          <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-50">
            <div className="text-6xl font-bold font-['Fredoka',sans-serif] text-[#7fe0b0] animate-pulse drop-shadow-[0_0_30px_rgba(127,224,176,0.8)]">
              PANGRAM!
            </div>
          </div>
        )}
