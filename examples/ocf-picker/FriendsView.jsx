    ...
    <div>
      <div className="flex flex-col items-center gap-1 p-2.5 bg-[#f7e8d8] dark:bg-[#241c10] rounded-2xl m-0.5  mb-1.5">
        ...
        <div className="flex items-center gap-[3px]">
          <button
            onClick={copyLink}
            className={`flex items-center gap-0.5 py-[7px] px-2.5 font-bold rounded-2xl m-0.5  transition-all ${copied ? 'bg-[#25a48f] text-white' : 'bg-[#efe4cf] dark:bg-[#1e1a12] text-[#3a2f28] dark:text-[#f0e9df] hover:bg-[#f7e8d8] dark:hover:bg-[#241c10]'}`}
          >
            {copied ? (
              <>
                <svg
        ...
        {friends.length + friendedBy.length > 0 && (
          <div className="flex items-center flex-wrap gap-0.5 mb-1.5">
            <button
              ...
              className={`py-[5px] px-2 font-black rounded-full m-0.5 transition-all ${selectedFriend === ALL_FRIENDS ? 'bg-[#d95931] text-white' : 'bg-[#25a48f] dark:bg-[#123d36] text-white hover:opacity-90'}`}
            >
              All
            </button>
            ...
            >
              <input
                ...
                className="w-4 h-4 accent-[#d95931]"
              />
              include my faves
            </label>
          </div>
