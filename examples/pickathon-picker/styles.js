...
export const c = {
  ...
  input: "p-[7px] m-0.5 rounded-xl font-bold text-[#4A4A4A] dark:text-[#e9e9e9] bg-white dark:bg-[#22252d]",
  navBtn: (active) =>
  ...
  btnPink: "bg-[#CD6C0C] text-white font-bold py-[7px] px-2.5 rounded-2xl m-0.5 hover:opacity-90 transition-all",
  btnCyan: "bg-[#71AD44] dark:bg-[#1d3015] text-white font-bold py-[7px] px-2.5 rounded-2xl m-0.5 hover:opacity-90 transition-all",
  // Same button, in-flight: color-only cue (orange) while the write lands. Copy is unchanged.
  btnCyanWorking: "bg-[#CD6C0C] text-white font-bold py-[7px] px-2.5 rounded-2xl m-0.5 opacity-90 transition-all cursor-wait",
  badge: "bg-[#CD6C0C] text-white px-[3px] py-[1px] rounded-full text-sm font-bold m-0.5",
  favToggleOn: "p-[7px] rounded-2xl m-0.5 font-bold transition-all bg-[#CD6C0C] text-white hover:opacity-90",
  favToggleOff:
