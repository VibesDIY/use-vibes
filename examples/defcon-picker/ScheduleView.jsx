...
function GapStrip({ startMs, endMs, allDayEvents, fmtTime }) {
  ...
  return (
    <div className="rounded-lg m-0.5 px-[7px] py-[5px] bg-white/10 flex items-center gap-0.5">
      <span className="text-xs font-bold text-[#e8e8e8]/60">
                        ...
                        <div className="flex items-center gap-0.5 flex-wrap mb-[1px]">
                          ...
                          {isEvent && onToggleFavorite && (
                            <button
                              ...
                              className={`p-[1px] rounded-lg m-0.5 text-xs font-bold px-0.5 ${myFavIds && myFavIds.has(item.data.eventId) ? 'bg-[#39ff14] text-[#0a0a0c]' : 'bg-[#1a1a20] text-[#e8e8e8]'}`}
                            >
