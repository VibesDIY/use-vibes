...
export const c = {
  ...
  btnAccent:
    'bg-[#39ff14] text-[#0a0a0c] font-bold py-[7px] px-2.5 rounded-2xl m-0.5 hover:opacity-90 transition-all',
  btnDim:
  ...
  favToggleOn:
    'p-[7px] rounded-2xl m-0.5 font-bold transition-all bg-[#39ff14] text-[#0a0a0c] hover:opacity-90',
  favToggleOff:
    'p-[7px] rounded-2xl m-0.5 font-bold transition-all bg-[#1a1a20] text-[#e8e8e8] hover:bg-[#26262e]',
  linkBtn:
    'p-[7px] bg-[#1a1a20] text-[#e8e8e8] rounded-2xl m-0.5 hover:bg-[#26262e] transition-all',
  noteArea:
    'w-full p-1.5 m-0.5 rounded-[4px] resize-none text-[16px] text-[#e8e8e8] bg-transparent border border-[#e8e8e8]/30',
  ...
  readOnlyBanner:
    'mt-0.5 bg-[#1a1a20] text-[#e8e8e8] px-[7px] py-1.5 rounded-lg text-sm font-bold m-0.5',
...
export const lineupTag = (event) => {
  ...
  return {
    label,
    color: event.lineup?.color || '#39ff14',
    textColor: event.lineup?.textColor || '#ffffff',
  };
};
