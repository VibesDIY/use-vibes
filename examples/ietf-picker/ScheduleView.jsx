  ...
  return (
    <>
      {days.map((day) => {
        ...
        const allDayEvents =
          showGaps && allEvents ? allEvents.filter((e) => meetingDayFor(e.start) === day) : [];
                ...
                return (
                  <div
                    ...
                    className={
                      item.type === 'shift'
                        ? c.schedShift
                        : `rounded-md m-0.5 p-[7px] ${eventCardBg}`
                    }
                      ...
                      <div className="flex-1">
                        ...
                        {isEvent &&
                          (canWrite && saveNote ? (
                            ...
                            <div
                              className={`mt-0.5 p-1.5 bg-[#f1f4f8] dark:bg-[#21262d] rounded-lg m-0.5`}
                            >
                              <p className={`text-sm font-bold ${c.bodyText}`}>
