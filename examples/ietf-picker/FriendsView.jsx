    ...
    <div>
      <div className="flex flex-col items-center gap-1 p-2.5 bg-[#e9eef5] dark:bg-[#101826] rounded-lg m-0.5 mb-1.5">
        ...
        <div className="flex items-center gap-[3px]">
          <button
            onClick={copyLink}
            className={`flex items-center gap-0.5 py-[7px] px-2.5 font-bold rounded-lg m-0.5 transition-all ${copied ? "bg-[#205a9e] text-white" : "bg-white dark:bg-[#21262d] text-[#1f2328] dark:text-[#e6edf3] hover:bg-[#e9eef5] dark:hover:bg-[#101826]"}`}
          >
            {copied ? (
              <>
                <svg
        ...
        {friends.length + friendedBy.length > 0 && (
          <div className="flex items-center flex-wrap gap-0.5 mb-1.5">
            <button
              ...
              className={`py-[5px] px-2 font-black rounded-full m-0.5 transition-all ${selectedFriend === ALL_FRIENDS ? "bg-[#b45309] text-white" : "bg-[#205a9e] dark:bg-[#132f4f] text-white hover:opacity-90"}`}
            >
              All
            </button>
