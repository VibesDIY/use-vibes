...
export const c = {
  ...
  input: "p-[7px] m-0.5 rounded-md font-bold text-[#1f2328] dark:text-[#e6edf3] bg-white dark:bg-[#21262d]",
  navBtn: (active) =>
  ...
  btnPink: "bg-[#b45309] text-white font-bold py-[7px] px-2.5 rounded-lg m-0.5 hover:opacity-90 transition-all",
  btnCyan: "bg-[#205a9e] dark:bg-[#132f4f] text-white font-bold py-[7px] px-2.5 rounded-lg m-0.5 hover:opacity-90 transition-all",
  // Same button, in-flight: color-only cue (amber) while the write lands. Copy is unchanged.
  btnCyanWorking: "bg-[#b45309] text-white font-bold py-[7px] px-2.5 rounded-lg m-0.5 opacity-90 transition-all cursor-wait",
  badge: "bg-[#b45309] text-white px-[3px] py-[1px] rounded-full text-sm font-bold m-0.5",
  favToggleOn: "p-[7px] rounded-lg m-0.5 font-bold transition-all bg-[#b45309] text-white hover:opacity-90",
  favToggleOff:
...
export const lineupTag = (event) => {
  ...
  return { label, color: event.lineup?.color || "#34495e", textColor: event.lineup?.textColor || "#fff" };
};
