    ...
    <div>
      <div className="mb-1.5 flex flex-wrap gap-1">
        <input
          ...
          className={`flex-1 min-w-64 p-2 m-0.5 ${c.border}  text-lg font-bold ${c.bodyText}`}
        />
        <select
          value={selectedDay}
          onChange={(e) => setSelectedDay(e.target.value)}
          className={`p-2 m-0.5 ${c.border}  font-bold bg-[#403D31] ${c.bodyText}`}
        >
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-1">
                      ...
                      <div className="flex gap-0.5">
                        {canFavorite && (
                          ...
                          >
                            <FavMark filled={myFavIds.has(event.eventId)} />
                          </button>
                        )}
                        <a
                          href={event.url}
