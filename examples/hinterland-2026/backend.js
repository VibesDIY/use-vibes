// Hinterland Picker backend: serve faves schedules as .ics.
//
// POST /_api/faves.ics  { items: [{ id, title, start, end, location?, url? }] }
//   → 200 text/calendar attachment (hinterland-faves.ics) — one-shot download of
...
//   live feed: new picks flow to every subscriber without re-subscribing, with
//   set times read from the embedded final Hinterland snapshot (no live feed to
//   re-join — the lineup is fixed).
//
...
// Hinterland ships NO structured schedule feed and its 2026 lineup is FINAL, so
// (unlike the live-feed re-join in the Pickathon original) the set times are an
// embedded snapshot — DUPLICATED verbatim from festival-utils.js HINTERLAND_SCHEDULE
// (this isolate runs alone, no imports). Keyed by the same deterministic eventId
// (date|HH:MM|stageSlug|titleSlug) the app writes onto its favorite docs, so the
// scheduled tick's favorite eventIds project straight into calendar items.
// >>> SCHEDULE SNAPSHOT (generated from festival-config.js — keep in sync)
// backend-sync.test.js fails the build if this drifts from festival-config.js.
// NOTE (live-app deviation): entries keep the SHIPPED field names — `title` and
// `location`, no `day` — because scheduleItemsFor() below reads them and the
// calendar items they produce are already in subscribers' calendar clients.
export const BACKEND_TZ = 'America/Chicago';
// The LIVE database name. Must equal FESTIVAL.dbName; changing it orphans every
// user's favorites.
export const BACKEND_DB = 'hinterland2026';
export const BACKEND_NAME = 'Hinterland';
export const SCHEDULE_BY_ID = {
  '2026-07-30|13:00|main|porch-light': {
    title: 'Porch Light',
  ...
  '2026-07-30|14:00|main|frost-children': {
  ...
  '2026-07-30|15:00|main|jane-remover': {
    title: 'Jane Remover',
  ...
  '2026-07-30|17:15|main|audrey-nuna': {
    title: 'AUDREY NUNA',
  ...
  '2026-07-30|18:30|main|ashnikko': {
    title: 'ASHNIKKO',
  ...
  '2026-07-30|20:00|main|beabadoobee': {
    title: 'beabadoobee',
  ...
  '2026-07-31|14:00|main|saint-avangeline': {
    title: 'Saint Avangeline',
    start: '2026-07-31T14:00:00',
    end: '2026-07-31T15:00:00',
    location: 'Main Stage',
    url: 'https://www.hinterlandiowa.com/lineup',
  },
  '2026-07-31|15:00|main|wisp': {
    title: 'Wisp',
  ...
  '2026-07-31|16:00|main|sofia-isella': {
    title: 'SOFIA ISELLA',
  ...
  '2026-07-31|17:00|main|paris-paloma': {
    title: 'Paris Paloma',
  ...
  '2026-07-31|18:15|main|snow-strippers': {
  ...
  '2026-08-01|13:45|main|waylon-wyatt': {
    title: 'Waylon Wyatt',
  ...
  '2026-08-01|14:45|main|julia-wolf': {
    title: 'Julia Wolf',
  ...
  '2026-08-01|17:00|main|santigold': {
    title: 'Santigold',
  ...
  '2026-08-01|18:30|main|the-format': {
    title: 'The Format',
  ...
  '2026-08-01|20:00|main|jessie-murph': {
    title: 'Jessie Murph',
  ...
  '2026-08-01|21:45|main|mumford-sons': {
    title: 'Mumford & Sons',
  ...
  '2026-08-02|12:15|main|haute-freddy': {
    title: 'Haute & Freddy',
  ...
  '2026-08-02|14:15|main|audrey-hobert': {
    title: 'Audrey Hobert',
  ...
  '2026-08-02|15:30|main|suki-waterhouse': {
  ...
  '2026-08-02|19:30|main|young-miko': {
    title: 'Young Miko',
  ...
  '2026-08-02|21:30|main|kali-uchis': {
    title: 'Kali Uchis',
  ...
  '2026-07-30|16:45|miniland|duo-beats': {
    title: 'Duo Beats',
    start: '2026-07-30T16:45:00',
    end: '2026-07-30T18:00:00',
    location: 'Miniland Stage',
    url: 'https://www.hinterlandiowa.com/lineup',
  },
  '2026-07-30|18:00|miniland|lipstick-homicide': {
    title: 'Lipstick Homicide',
    start: '2026-07-30T18:00:00',
    end: '2026-07-30T19:00:00',
    location: 'Miniland Stage',
    url: 'https://www.hinterlandiowa.com/lineup',
  },
  '2026-07-31|14:30|miniland|crooked-torus': {
    title: 'Crooked Torus',
  ...
  '2026-07-31|16:30|miniland|sarah-tonin': {
    title: 'Sarah Tonin',
  ...
  '2026-07-31|17:45|miniland|leslie-the-ly-s': {
    title: "Leslie & The Ly's",
    start: '2026-07-31T17:45:00',
    end: '2026-07-31T18:45:00',
    location: 'Miniland Stage',
    url: 'https://www.hinterlandiowa.com/lineup',
  },
  '2026-08-01|14:15|miniland|derry-the-dirty-dishes': {
    title: 'Derry & the Dirty Dishes',
    start: '2026-08-01T14:15:00',
    end: '2026-08-01T15:15:00',
    location: 'Miniland Stage',
    url: 'https://www.hinterlandiowa.com/lineup',
  },
  '2026-08-01|15:15|miniland|quintron-miss-pussycat': {
  ...
  '2026-08-02|15:00|miniland|koo-koo': {
    title: 'Koo Koo',
  ...
  '2026-08-02|16:15|miniland|jeffery-lewis': {
    title: 'Jeffery Lewis',
  ...
  '2026-07-30|23:30|campfire|nourished-by-time': {
  ...
  '2026-07-31|00:30|campfire|pixel-grip': {
    title: 'Pixel Grip',
  ...
  '2026-07-31|23:30|campfire|between-friends': {
  ...
  '2026-08-01|00:30|campfire|ninajirachi': {
    title: 'Ninajirachi',
  ...
  '2026-08-01|23:30|campfire|the-brook-the-bluff': {
  ...
  '2026-08-02|00:30|campfire|buffalo-traffic-jam': {
    title: 'Buffalo Traffic Jam',
    start: '2026-08-02T00:30:00',
    end: '2026-08-02T01:30:00',
    location: 'Campfire Stage',
    url: 'https://www.hinterlandiowa.com/lineup',
  },
  '2026-08-02|23:30|campfire|die-spitz': {
    title: 'Die Spitz',
  ...
  '2026-08-03|00:30|campfire|gouge-away': {
    title: 'Gouge Away',
...
// Project the requested favorite eventIds into calendar items from the embedded
// snapshot. The lineup is final, so there is no live feed to re-join and no
// failure mode here (the Pickathon original fetched pickathon.com each refresh);
// an unknown id (favorited then removed from the lineup) simply drops out.
export const scheduleItemsFor = (ids) => {
  const items = [];
  for (const id of ids) {
    const ev = SCHEDULE_BY_ID[id];
    if (!ev) continue;
    items.push({
      id: `event-${id}`,
      title: ev.title,
...
const icsUid = (item) => {
  ...
  return `${key.replace(/[^A-Za-z0-9._-]/g, '-')}@hinterland-2026.vibes.diy`;
};
...
export const buildFavesCalendar = (items, { now, calName } = {}) => {
  ...
  const lines = [
    'BEGIN:VCALENDAR',
    'VERSION:2.0',
    'PRODID:-//vibes.diy//hinterland-2026//EN',
    'CALSCALE:GREGORIAN',
    'METHOD:PUBLISH',
    `X-WR-CALNAME:${escapeIcsText(calName || 'My Hinterland Picks')}`,
...
const handleDownload = async (request) => {
  ...
  return new Response(ics, {
    ...
    headers: {
      ...
      'content-disposition': 'attachment; filename="hinterland-faves.ics"',
...
const ANCHOR_ITEMS = [
  {
    id: 'gates-open-2026',
    title: 'Hinterland — Gates Open',
    start: '2026-07-30T11:00:00',
    end: '2026-07-30T12:00:00',
    location: 'Avenue of the Saints Amphitheater, St. Charles, Iowa',
    url: 'https://www.hinterlandiowa.com',
  },
];
...
const handleSubscription = async (url) => {
  ...
  const entry = (handle && subCache.users.get(handle)) || {
    eventIds: [],
    shifts: [],
  };
  const eventItems = entry.eventIds.length > 0 ? scheduleItemsFor(entry.eventIds) : [];
  ...
  return new Response(
    buildFavesCalendar(items, {
      calName: `@${handle ?? displayName ?? 'my'} — Hinterland Picks`,
    }),
    {
      status: 200,
      headers: {
