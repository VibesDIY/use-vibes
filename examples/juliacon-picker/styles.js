...
export const c = {
  ...
  input:
    'p-[7px] m-0.5 rounded-xl font-bold text-[#2a2a2a] dark:text-[#ece9f1] bg-white dark:bg-[#262031]',
  navBtn: (active) =>
  ...
  btnPink:
    'bg-[#CB3C33] text-white font-bold py-[7px] px-2.5 rounded-2xl m-0.5 hover:opacity-90 transition-all',
  btnCyan:
    'bg-[#9558B2] dark:bg-[#3a2545] text-white font-bold py-[7px] px-2.5 rounded-2xl m-0.5 hover:opacity-90 transition-all',
  // Same button, in-flight: color-only cue (red) while the write lands. Copy is unchanged.
  btnCyanWorking:
    'bg-[#CB3C33] text-white font-bold py-[7px] px-2.5 rounded-2xl m-0.5 opacity-90 transition-all cursor-wait',
  badge: 'bg-[#CB3C33] text-white px-[3px] py-[1px] rounded-full text-sm font-bold m-0.5',
  favToggleOn:
    'p-[7px] rounded-2xl m-0.5 font-bold transition-all bg-[#CB3C33] text-white hover:opacity-90',
  favToggleOff:
...
export const lineupTag = (event) => {
  ...
  return {
    label,
    color: event.lineup?.color || '#9558B2',
