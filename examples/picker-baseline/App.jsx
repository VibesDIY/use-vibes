...
import { favoriteDocId, noteDocId, migrateFestivalDoc, icsSubscribePath, ensureCalToken } from './docs.js';
import {
  LOADSHED_TYPE,
  shedLevelFromDocs,
...
function Logo() {
  ...
  return (
    <img src={LOGO_URL} alt={FESTIVAL.name} className="h-32 w-auto" onError={() => setFailed(true)} />
  );
}
