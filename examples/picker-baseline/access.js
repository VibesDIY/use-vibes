export default function (doc, oldDoc, user, ctx) {
  ...
  // and mirrors the festival's published schedule into one `scheduleitem` doc per event.
  ...
  // tell "unchanged" without re-reading the schedule docs at all.
  // OWNER-ONLY WRITE is the point: this
