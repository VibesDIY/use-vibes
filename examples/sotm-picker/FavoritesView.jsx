...
export default function FavoritesView({
  ...
  return (
    <div>
      <div className="mb-1.5 p-2 bg-[#d8e8c8] dark:bg-[#16220e] rounded-2xl m-0.5 ">
        ...
        <div className="flex flex-wrap gap-0.5">
          {favUsers.map((u) => (
            <button
              ...
              className={`flex items-center gap-0.5 p-[1px] rounded-full m-0.5  transition-all ${viewingUser === u.userId || (!viewingUser && u.userId === userId) ? "bg-[#2d6a8f]" : "bg-white dark:bg-[#1b2913] hover:bg-[#4c7a34] dark:hover:bg-[#1c3012]"}`}
